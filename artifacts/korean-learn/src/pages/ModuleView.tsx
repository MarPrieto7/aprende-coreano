...
const MODULE_STYLES = [
  ...
  { gradient: "from-[#c2460a] to-[#a83808]", light: "bg-[#fff7ed]", text: "text-[#c2460a]", border: "border-[#c2460a]/20", barColor: "#c2460a" },
  { gradient: "from-[#6d28d9] to-[#5b21b6]", light: "bg-[#f5f3ff]", text: "text-[#6d28d9]", border: "border-[#6d28d9]/20", barColor: "#6d28d9" },
];
